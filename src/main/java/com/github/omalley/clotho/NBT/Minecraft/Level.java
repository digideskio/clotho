...
public class Level
{
	...
	public static class Player extends Mob
	{
		...
		public static enum Dimension
		{
			...
			/**
			 * Returns the enumeration constant represented by the given ID_ATTR.
			 * @param ordinal The dimension ID_ATTR.
			 * @return The enumeration constant represented by the given ID_ATTR.
			 * @throws FormatException if the given ID_ATTR is not recognized as a dimension.
			 */
			...
			/**
			 * Returns the ID_ATTR of this dimension constant.
			 * @return The ID_ATTR of this dimension constant.
			 */
			public byte ID()
			{
				switch(this)
		...
		public Player(Tag.Compound player) throws FormatException
		{
			...
			sleeping = ((Tag.ByteTag)player.find(Tag.Type.BYTE, "Sleeping")).v != 0 ? true : false;
			sleeptimer = ((Tag.ShortTag)player.find(Tag.Type.SHORT, "SleepTimer")).v;
			dimension = Dimension.FromID(((Tag.IntTag)player.find(Tag.Type.INT, "Dimension")).v);
			playergametype = GameMode.FromID(((Tag.IntTag)player.find(Tag.Type.INT, "playerGameType")).v);
			foodlevel = ((Tag.IntTag)player.find(Tag.Type.INT, "foodLevel")).v;
			foodticktimer = ((Tag.IntTag)player.find(Tag.Type.INT, "foodTickTimer")).v;
			foodexhaustionlevel = ((Tag.FloatTag)player.find(Tag.Type.FLOAT, "foodExhaustionLevel")).v;
			foodsaturationlevel = ((Tag.FloatTag)player.find(Tag.Type.FLOAT, "foodSaturationLevel")).v;
			try
			{
				spawnx = ((Tag.IntTag)player.find(Tag.Type.INT, "SpawnX")).v;
				spawny = ((Tag.IntTag)player.find(Tag.Type.INT, "SpawnY")).v;
				spawnz = ((Tag.IntTag)player.find(Tag.Type.INT, "SpawnZ")).v;
			}
			catch(FormatException e)
			{
				spawnx = spawny = spawnz = null;
			}
			xplevel = ((Tag.IntTag)player.find(Tag.Type.INT, "XpLevel")).v;
			xptotal = ((Tag.IntTag)player.find(Tag.Type.INT, "XpTotal")).v;
			xpp = ((Tag.FloatTag)player.find(Tag.Type.FLOAT, "XpP")).v;
			inventory = new Inventory((Tag.ListTag)player.find(Tag.Type.LIST, "Inventory"));
			enderitems = new Inventory((Tag.ListTag)player.find(Tag.Type.LIST, "EnderItems"));
			Tag.Compound abilities = (Tag.Compound)player.find(Tag.Type.COMPOUND, "abilities");
			mayfly = ((Tag.ByteTag)abilities.find(Tag.Type.BYTE, "mayfly")).v != 0 ? true : false;
			flyspeed = ((Tag.FloatTag)abilities.find(Tag.Type.FLOAT, "flySpeed")).v;
			flying = ((Tag.ByteTag)abilities.find(Tag.Type.BYTE, "flying")).v != 0 ? true : false;
			maybuild = ((Tag.ByteTag)abilities.find(Tag.Type.BYTE, "mayBuild")).v != 0 ? true : false;
			instabuild = ((Tag.ByteTag)abilities.find(Tag.Type.BYTE, "instabuild")).v != 0 ? true : false;
			invulnerable = ((Tag.ByteTag)abilities.find(Tag.Type.BYTE, "invulnerable")).v != 0 ? true : false;
			walkspeed = ((Tag.FloatTag)abilities.find(Tag.Type.FLOAT, "walkSpeed")).v;
		}
	...
	public Level(Tag.Compound level) throws FormatException
	{
		...
		version = ((Tag.IntTag)level.find(Tag.Type.INT, "version")).v;
		if(version != 19133)
		{
			throw new FormatException("Incorrect Version: "+version);
		}
		levelname = ((Tag.StringTag)level.find(Tag.Type.STRING, "LevelName")).v;
		allowcommands = ((Tag.ByteTag)level.find(Tag.Type.BYTE, "allowCommands")).v != 0 ? true : false;
		gametype = Player.GameMode.FromID(((Tag.IntTag)level.find(Tag.Type.INT, "GameType")).v);
		hardcore = ((Tag.ByteTag)level.find(Tag.Type.BYTE, "hardcore")).v != 0 ? true : false;
		mapfeatures = ((Tag.ByteTag)level.find(Tag.Type.BYTE, "MapFeatures")).v != 0 ? true : false;
		time = ((Tag.LongTag)level.find(Tag.Type.LONG, "Time")).v;
		raining = ((Tag.ByteTag)level.find(Tag.Type.BYTE, "raining")).v != 0 ? true : false;
		raintime = ((Tag.IntTag)level.find(Tag.Type.INT, "rainTime")).v;
		thundering = ((Tag.ByteTag)level.find(Tag.Type.BYTE, "thundering")).v != 0 ? true : false;
		thundertime = ((Tag.IntTag)level.find(Tag.Type.INT, "thunderTime")).v;
		generator = Generator.FromName(((Tag.StringTag)level.find(Tag.Type.STRING, "generatorName")).v);
		generatorversion = ((Tag.IntTag)level.find(Tag.Type.INT, "generatorVersion")).v;
		randomseed = ((Tag.LongTag)level.find(Tag.Type.LONG, "RandomSeed")).v;
		spawnx = ((Tag.IntTag)level.find(Tag.Type.INT, "SpawnX")).v;
		spawny = ((Tag.IntTag)level.find(Tag.Type.INT, "SpawnY")).v;
		spawnz = ((Tag.IntTag)level.find(Tag.Type.INT, "SpawnZ")).v;
		lastplayed = ((Tag.LongTag)level.find(Tag.Type.LONG, "LastPlayed")).v;
		sizeondisk = ((Tag.LongTag)level.find(Tag.Type.LONG, "SizeOnDisk")).v;
	...
	public Tag.Compound ToNBT(String name)
	{
		Tag.Compound data, t = new Tag.Compound(name,
						data = new Tag.Compound("Data", new Tag.IntTag("version", 19133),
														new Tag.StringTag("LevelName", levelname),
														new Tag.ByteTag("allowCommands", (byte)(allowcommands?1:0)),
														new Tag.IntTag("GameType", gametype.ordinal()),
														new Tag.ByteTag("hardcore", (byte)(hardcore?1:0)),
														new Tag.ByteTag("MapFeatures", (byte)(mapfeatures?1:0)),
														new Tag.LongTag("Time", time),
														new Tag.ByteTag("raining", (byte)(raining?1:0)),
														new Tag.IntTag("rainTime", raintime),
														new Tag.ByteTag("thundering", (byte)(thundering?1:0)),
														new Tag.IntTag("thunderTime", thundertime),
														new Tag.StringTag("generatorName", ""+generator),
														new Tag.IntTag("generatorVersion", generatorversion),
														new Tag.LongTag("RandomSeed", randomseed),
														new Tag.IntTag("SpawnX", spawnx),
														new Tag.IntTag("SpawnY", spawny),
														new Tag.IntTag("SpawnZ", spawnz),
														new Tag.LongTag("LastPlayed", lastplayed),
														new Tag.LongTag("SizeOnDisk", sizeondisk)));
		if(player != null)
		{
