...
public abstract class Mob extends Entity
{
	...
	public static abstract class Leash
	{
		...
		public static Leash FromNBT(Tag.Compound t) throws FormatException
		{
			try
			{
				int x = ((Tag.IntTag)t.find(Tag.Type.INT, "X")).v,
				    y = ((Tag.IntTag)t.find(Tag.Type.INT, "Y")).v,
				    z = ((Tag.IntTag)t.find(Tag.Type.INT, "Z")).v;
				return new Leash.Fence(x, y, z);
			}
			catch(FormatException e)
			{
			}
			long least = ((Tag.LongTag)t.find(Tag.Type.LONG, "UUIDLeast")).v,
			     most  = ((Tag.LongTag)t.find(Tag.Type.LONG, "UUIDMost")).v;
		...
		public static class Fence extends Leash
		{
			...
			{
				return new Tag.Compound(name, new Tag.IntTag("X", x),
				                              new Tag.IntTag("Y", y),
				                              new Tag.IntTag("Z", z));
			}
		}
		public static class UUID extends Leash
		{
			...
			public Tag.Compound ToNBT(String name)
			{
				return new Tag.Compound(name, new Tag.LongTag("UUIDLeast", least),
				                              new Tag.LongTag("UUIDMost", most));
			}
		}
	}
	/**
	...
	public Mob(Tag.Compound mob) throws FormatException
	{
		...
		health = ((Tag.ShortTag)mob.find(Tag.Type.SHORT, "Health")).v;
		attacktime = ((Tag.ShortTag)mob.find(Tag.Type.SHORT, "AttackTime")).v;
		hurttime = ((Tag.ShortTag)mob.find(Tag.Type.SHORT, "HurtTime")).v;
		deathtime = ((Tag.ShortTag)mob.find(Tag.Type.SHORT, "DeathTime")).v;
		Tag.ListTag effects = null;
		try
		{
			effects = (Tag.ListTag)mob.find(Tag.Type.LIST, "ActiveEffects");
		}
		catch(FormatException e)
		{
		}
		if(effects != null)
		{
			...
			{
				throw new FormatException("Invalid Potion Effects ListTag; expected list of Compound, got list of "+effects.Supports());
			}
			for(Tag t : effects)
			{
				Tag.Compound effect = (Tag.Compound)t;
				activeeffects.put(Effect.FromID(((Tag.ByteTag)effect.find(Tag.Type.BYTE, "Id")).v),
				                  new EffectInfo(((Tag.ByteTag)mob.find(Tag.Type.BYTE, "Amplifier")).v,
				                                 ((Tag.IntTag)mob.find(Tag.Type.INT, "Duration")).v,
				                                 ((Tag.ByteTag)mob.find(Tag.Type.BYTE, "Ambient")).v  == 1 ? true : false));
			}
		}

    Tag.ListTag equip = (Tag.ListTag)mob.find(Tag.Type.LIST, "Equipment");
    equipment.put(EquipmentSlot.Hand,     new Item((Tag.Compound)equip.Get(EquipmentSlot.Hand.    ID())));
    equipment.put(EquipmentSlot.Boots,    new Item((Tag.Compound)equip.Get(EquipmentSlot.Boots.   ID())));
    equipment.put(EquipmentSlot.Leggings, new Item((Tag.Compound)equip.Get(EquipmentSlot.Leggings.ID())));
    equipment.put(EquipmentSlot.Chest,    new Item((Tag.Compound)equip.Get(EquipmentSlot.Chest.   ID())));
    equipment.put(EquipmentSlot.Helmet,   new Item((Tag.Compound)equip.Get(EquipmentSlot.Helmet.  ID())));

    Tag.ListTag drops = (Tag.ListTag)mob.find(Tag.Type.LIST, "DropChances");
    dropchances.put(EquipmentSlot.Hand,     ((Tag.FloatTag)equip.Get(EquipmentSlot.Hand.    ID())).v);
    dropchances.put(EquipmentSlot.Boots,    ((Tag.FloatTag)equip.Get(EquipmentSlot.Boots.   ID())).v);
    dropchances.put(EquipmentSlot.Leggings, ((Tag.FloatTag)equip.Get(EquipmentSlot.Leggings.ID())).v);
    dropchances.put(EquipmentSlot.Chest,    ((Tag.FloatTag)equip.Get(EquipmentSlot.Chest.   ID())).v);
    dropchances.put(EquipmentSlot.Helmet,   ((Tag.FloatTag)equip.Get(EquipmentSlot.Helmet.  ID())).v);

    canpickuploot = ((Tag.ByteTag)mob.find(Tag.Type.BYTE, "CanPickUpLoot")).v == 1 ? true : false;
    persistencerequired = ((Tag.ByteTag)mob.find(Tag.Type.BYTE, "PersistenceRequired")).v == 1 ? true : false;

		try
		{
			customname = ((Tag.StringTag)mob.find(Tag.Type.STRING, "CustomName")).v;
		}
		catch(FormatException e)
		{
			customname = null;
		...
		try
		{
			customnamevisible = ((Tag.ByteTag)mob.find(Tag.Type.BYTE, "CustomNameVisible")).v == 1 ? true : false;
		}
		catch(FormatException e)
		{
		...
		try
		{
			healf = ((Tag.FloatTag)mob.find(Tag.Type.FLOAT, "HealF")).v;
		}
		catch(FormatException e)
		{
			healf = health;
		...
		try
		{
			if(((Tag.ByteTag)mob.find(Tag.Type.BYTE, "Leashed")).v == 1)
			{
	 ...
	 */
	public Mob(double X, double Y, double Z) throws FormatException {
		super(X, Y, Z);
		health = 20;
		attacktime = 0;
		hurttime = 0;
	 ...
	 */
	public Item Equipment(EquipmentSlot e)
	{
	 ...
	 */
	public void Equipment(EquipmentSlot e, Item i)
	{
		equipment.put(e, i);
	}
	/**
	...
	public static abstract class Breedable extends Mob
	{
		...
		{
			super(breedable);
      Tag.IntTag inloveTag = (Tag.IntTag) breedable.get("InLove");
      inlove = inloveTag == null ? 0 : inloveTag.v;
			age = ((Tag.IntTag)breedable.find(Tag.Type.INT, "Age")).v;
		}
		/**
		 ...
		 * @param Z The Z position.
		 */
		public Breedable(double X, double Y, double Z) throws FormatException
		{
			super(X, Y, Z);
			inlove = 0;
			age = 0;
		...
		@Override public Tag.Compound ToNBT(String name)
		{
			...
			t.Add(new Tag.IntTag("InLove", inlove),
				  new Tag.IntTag("Age", age));
			return t;
		}
	}
	/**
	...
	public static abstract class Tameable extends Breedable
	{
		...
		public Tameable(Tag.Compound tameable) throws FormatException
		{
			...
			owner = ((Tag.StringTag)tameable.find(Tag.Type.STRING, "Owner")).v;
			sitting = ((Tag.ByteTag)tameable.find(Tag.Type.BYTE, "Sitting")).v != 0 ? true : false;
		}
		/**
		 ...
		 * @param Z The Z position.
		 */
		public Tameable(double X, double Y, double Z) throws FormatException
		{
			super(X, Y, Z);
			owner = "";
			sitting = false;
		...
		{
			Tag.Compound t = super.ToNBT(name);
			t.Add(new Tag.StringTag("Owner", owner),
				  new Tag.ByteTag("Sitting", (byte)(sitting?1:0)));
			return t;
		}
	}
	...
	public static class Blaze extends Mob
	{
		 ...
		 * @param Z The Z position.
		 */
		public Blaze(double X, double Y, double Z) throws FormatException
		{
			super(X, Y, Z);
		}
	}
	...
	public static class CaveSpider extends Mob
	{
		 ...
		 * @param Z The Z position.
		 */
		public CaveSpider(double X, double Y, double Z) throws FormatException
		{
			super(X, Y, Z);
		}
	}
	...
	public static class Chicken extends Breedable
	{
		 ...
		 * @param Z The Z position.
		 */
		public Chicken(double X, double Y, double Z) throws FormatException
		{
			super(X, Y, Z);
		}
	}
	...
	public static class Cow extends Breedable
	{
		 ...
		 * @param Z The Z position.
		 */
		public Cow(double X, double Y, double Z) throws FormatException
		{
			super(X, Y, Z);
		}
	}
	...
	public static class Creeper extends Mob
	{
		...
		public Creeper(Tag.Compound creeper) throws FormatException
		{
			...
			try
			{
				powered = ((Tag.ByteTag)creeper.find(Tag.Type.BYTE, "powered")).v != 0 ? true : false;
			}
			catch(FormatException e)
			{
				powered = false;
		 ...
		 * @param Z The Z position.
		 */
		public Creeper(double X, double Y, double Z) throws FormatException
		{
			super(X, Y, Z);
			powered = false;
		}
		...
		{
			Tag.Compound t = super.ToNBT(name);
			t.Add(new Tag.ByteTag("powered", (byte)(powered?1:0)));
			return t;
		}
	}
	/**
	...
	public static class EnderDragon extends Mob
	{
		 ...
		 * @param Z The Z position.
		 */
		public EnderDragon(double X, double Y, double Z) throws FormatException
		{
			super(X, Y, Z);
		}
	}
	...
	{
		/**
		 * The ID_ATTR of the block being carried.
		 */
		...
		public Enderman(Tag.Compound enderman) throws FormatException
		{
			...
			carried = ((Tag.ShortTag)enderman.find(Tag.Type.SHORT, "carried")).v;
			carrieddata = ((Tag.ShortTag)enderman.find(Tag.Type.SHORT, "carriedData")).v;
		}
		/**
		 ...
		 * @param Z The Z position.
		 */
		public Enderman(double X, double Y, double Z)  throws FormatException
		{
			super(X, Y, Z);
			carried = 0;
			carrieddata = 0;
		...
		/**
		 * Returns the ID_ATTR of the block being carried.
		 * @return The ID_ATTR of the block being carried.
		 */
		...
		/**
		 * Sets the ID_ATTR of the block being carried.
		 * @param ID The ID_ATTR of the block being carried.
		 */
		...
		{
			Tag.Compound t = super.ToNBT(name);
			t.Add(new Tag.ShortTag("carried", carried),
				  new Tag.ShortTag("carriedData", carrieddata));
			return t;
		}
	}
	/**
	...
	public static class Ghast extends Mob
	{
		 ...
		 * @param Z The Z position.
		 */
		public Ghast(double X, double Y, double Z) throws FormatException
		{
			super(X, Y, Z);
		}
	}
	...
	public static class Giant extends Mob
	{
		 ...
		 * @param Z The Z position.
		 */
		public Giant(double X, double Y, double Z) throws FormatException
		{
			super(X, Y, Z);
		}
	}
	...
	public static class LavaSlime extends Slime
	{
		 ...
		 * @param Z The Z position.
		 */
		public LavaSlime(double X, double Y, double Z) throws FormatException
		{
			super(X, Y, Z);
		}
	}
	...
	public static class MushroomCow extends Breedable
	{
		 ...
		 * @param Z The Z position.
		 */
		public MushroomCow(double X, double Y, double Z) throws FormatException
		{
			super(X, Y, Z);
		}
	}
	...
	public static class Ozelot extends Tameable
	{
		 ...
		 * @param Z The Z position.
		 */
		public Ozelot(double X, double Y, double Z) throws FormatException
		{
			super(X, Y, Z);
		}
	}
	...
	public static class Pig extends Breedable
	{
		...
		public Pig(Tag.Compound pig) throws FormatException
		{
			...
			saddle = ((Tag.ByteTag)pig.find(Tag.Type.BYTE, "Saddle")).v != 0 ? true : false;
		}
		/**
		 ...
		 * @param Z The Z position.
		 */
		public Pig(double X, double Y, double Z)  throws FormatException
		{
			super(X, Y, Z);
			saddle = false;
		}
		...
		{
			Tag.Compound t = super.ToNBT(name);
			t.Add(new Tag.ByteTag("Saddle", (byte)(saddle?1:0)));
			return t;
		}
	}
	/**
	...
	public static class Sheep extends Breedable
	{
		...
		public Sheep(Tag.Compound sheep) throws FormatException
		{
			...
			sheared = ((Tag.ByteTag)sheep.find(Tag.Type.BYTE, "Sheared")).v != 0 ? true: false;
			color = Color.FromID(((Tag.ByteTag)sheep.find(Tag.Type.BYTE, "Color")).v);
		}
		/**
		 ...
		 * @param Z The Z position.
		 */
		public Sheep(double X, double Y, double Z) throws FormatException
		{
			super(X, Y, Z);
		}
		...
		{
			Tag.Compound t = super.ToNBT(name);
			t.Add(new Tag.ByteTag("Sheared", (byte)(sheared?1:0)),
				  new Tag.ByteTag("Color", (byte)color.ordinal()));
			return t;
		}
	}
	/**
	...
	public static class Silverfish extends Mob
	{
		 ...
		 * @param Z The Z position.
		 */
		public Silverfish(double X, double Y, double Z) throws FormatException
		{
			super(X, Y, Z);
		}
	}
	...
	public static class Skeleton extends Mob
	{
		 ...
		 * @param Z The Z position.
		 */
		public Skeleton(double X, double Y, double Z) throws FormatException
		{
			super(X, Y, Z);
		}
	}
	...
	public static class Slime extends Mob
	{
		 ...
		 * @param Z The Z position.
		 */
		public Slime(double X, double Y, double Z) throws FormatException
		{
			super(X, Y, Z);
			size = 0;
		}
		...
		{
			Tag.Compound t = super.ToNBT(name);
			t.Add(new Tag.IntTag("Size", size));
			return t;
		}
	}
	/**
	...
	public static class SnowMan extends Mob
	{
		 ...
		 * @param Z The Z position.
		 */
		public SnowMan(double X, double Y, double Z) throws FormatException
		{
			super(X, Y, Z);
		}
	}
	...
	public static class Spider extends Mob
	{
		 ...
		 * @param Z The Z position.
		 */
		public Spider(double X, double Y, double Z) throws FormatException
		{
			super(X, Y, Z);
		}
	}
	...
	public static class Squid extends Mob
	{
		 ...
		 * @param Z The Z position.
		 */
		public Squid(double X, double Y, double Z) throws FormatException
		{
			super(X, Y, Z);
		}
	}
	...
	public static class Villager extends Breedable
	{
		...
		public static enum Profession
		{
			...
			/**
			 * Given a profession ID_ATTR, returns the enumeration constant that represents that ID_ATTR.
			 * @param ordinal The ID_ATTR.
			 * @return The enumeration constant that represents the given ID_ATTR.
			 * @throws FormatException if the given ID_ATTR is unknown.
			 */
		...
		public static class Trade
		{
			...
			{
				uses = ((Tag.IntTag)trade.find(Tag.Type.INT, "uses")).v;
				buy = new Item((Tag.Compound)trade.find(Tag.Type.COMPOUND, "buy"));
				...
				{
					buyb = new Item((Tag.Compound)t);
				}
				sell = new Item((Tag.Compound)trade.find(Tag.Type.COMPOUND, "sell"));
			}
			/**
			 ...
			 */
			public Trade(Item costa, Item costb, Item sale)
			{
				uses = 0;
				buy = costa;
				buyb = costb;
			 ...
			 * @param b The second item required to complete this Trade offer, or null if there is no secondary requirement.
			 */
			public void Cost(Item a, Item b)
			{
				buy = a;
				buyb = b;
			}
		...
		public Villager(Tag.Compound villager) throws FormatException
		{
			...
			profession = Profession.FromID(((Tag.IntTag)villager.find(Tag.Type.INT, "Profession")).v);
			riches = ((Tag.IntTag)villager.find(Tag.Type.INT, "Riches")).v;
      Tag.Compound offersTag = (Tag.Compound) villager.get("Offers");
      if (offersTag != null) {
        Tag.ListTag trades = (Tag.ListTag)(offersTag.find(Tag.Type.LIST, "Recipes"));
		 ...
		 * @param Z The Z position.
		 */
		public Villager(double X, double Y, double Z) throws FormatException
		{
			super(X, Y, Z);
	...
	public static class VillagerGolem extends Mob
	{
		 ...
		 * @param Z The Z position.
		 */
		public VillagerGolem(double X, double Y, double Z) throws FormatException
		{
			super(X, Y, Z);
		}
	}
	...
	public static class Wolf extends Tameable
	{
		...
		public Wolf(Tag.Compound wolf) throws FormatException
		{
			...
			angry = ((Tag.ByteTag)wolf.find(Tag.Type.BYTE, "Angry")).v != 0 ? true : false;
		}
		/**
		 ...
		 * @param Z The Z position.
		 */
		public Wolf(double X, double Y, double Z) throws FormatException
		{
			super(X, Y, Z);
			angry = false;
		}
		...
		{
			Tag.Compound t = super.ToNBT(name);
			t.Add(new Tag.ByteTag("Angry", (byte)(angry?1:0)));
			return t;
		}
	}
	/**
	...
	public static class Zombie extends Mob
	{
		 ...
		 * @param Z The Z position.
		 */
		public Zombie(double X, double Y, double Z) throws FormatException
		{
			super(X, Y, Z);
		}
	}
	...
	public static class PigZombie extends Mob
	{
		...
		public PigZombie(Tag.Compound zombiepigman) throws FormatException
		{
			...
			anger = ((Tag.ShortTag)zombiepigman.find(Tag.Type.SHORT, "Anger")).v;
		}
		/**
		 ...
		 * @param Z The Z position.
		 */
		public PigZombie(double X, double Y, double Z)  throws FormatException
		{
			super(X, Y, Z);
			anger = 0;
		}
